...
define substitute-stdin: syntax (left right) as {
	# Limited process substitution. (Limit one per command).
	define fifo: temp-fifo
	define t: spawn: eval: append left fifo
	eval right < fifo
	wait t
	rm fifo
}
define substitute-stdout: syntax e (left right) as {
	# Limited process substitution. (Limit one per command).
	define fifo: temp-fifo
	define t: spawn: eval: append left fifo
	eval right > fifo
