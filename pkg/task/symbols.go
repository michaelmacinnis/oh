...
var symbols = []string{
	...
	"close", "closer", "cmd", "condition", "conduit", "_connect_", "cons",
	"context", "$PWD", "debug", "define", "dirs", "div", "echo", "else",
	...
	"is-float", "is-integer", "is-method", "is-null",
	...
	"set-source-file", "_set_", "source", "spawn", "_splice_",
